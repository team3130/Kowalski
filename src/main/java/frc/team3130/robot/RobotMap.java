...
public class RobotMap {
    ...
    public static double kLChassisTicksPerInch = 1500; //Measured kChassisCodesPerRev / (Math.PI * kLWheelDiameter);
    public static double kRChassisTicksPerInch = 1500; //Measured kChassisCodesPerRev / (Math.PI * kRWheelDiameter);
    ...
    public static double kLimelightPitch = (kUseCompbot ? -27.08 : -31.625);   // Facing up is negative Checked: 2/21
    public static double kLimelightYaw = 3.1-2.5;        // Aiming bias, facing left is positive FIXME: calibrate
